...
export const generateAccountFromPrivateKey = async (
  ...
  console.log("LOCK CONTAINS:", lock);
  return {
...
export async function buildMessageTx(
  ...
  // What CCC does here is: it calculates the minimum capacity needed
  // for  your output cell; it then automatically finds enough of your live cells as input to cover it
  await tx.completeInputsByCapacity(signer);
  // calculates the fee and if needed adds another input cell or adjusts an output to account for it
